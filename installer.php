...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_gamingtest_ebe80a3fff7ef8392037_20221207130754_archive.zip';
        const ARCHIVE_SIZE       = '53415291';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ebe80a3-07130754';
        const SECONDARY_PACKAGE_HASH = '746ca0a-07130754';
        const VERSION            = '1.5.1';
